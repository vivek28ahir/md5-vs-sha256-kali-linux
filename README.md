...
```
md5-vs-sha256-kali-linux/
├── README.md
├── images/
│   ├── figure1-md5-password123.png
│   ├── figure2-md5-cyber123.png
│   ├── figure3-md5-n3tworkla6.png
│   ├── figure4-sha256-password123.png
│   ├── figure5-sha256-cyber123.png
│   ├── figure6-sha256-n3tworkla6.png
│   ├── figure7-sha256-n3tworkla6-2026.png
│
├── report/
│   └── md5-vs-sha256-kali-linux.pdf
```
